...
lazy_static! {
    static ref ENGLISH_WORDS: [&'static str; 2048] = [
    ...
    static ref ENGLISH_DICTIONARY: HashMap<&'static str, usize> = {
        ENGLISH_WORDS
            .iter()
            .copied()
            .enumerate()
...
pub fn get_word(i: usize) -> &'static str {
    ENGLISH_WORDS[i]
}

pub fn get_index(word: &str) -> usize {
    *ENGLISH_DICTIONARY
        .get(&word)
